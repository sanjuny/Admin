...
function AdminSidebar() {
      ...
      const menus = [
          ...
          { name: "Employee management", link: "/EmployeeManagment", icon: HiUserGroup },
          { name: "Department management", link: "/Department", icon: BsFillBuildingsFill },
        
      ];
  return (
    <section className={`flex gap-6 ${open ? "w-72" : "w-16"}`}>
      <div
        className={`bg-[#0e0e0e] min-h-screen fixed ${open ? "w-72" : "w-16"}
